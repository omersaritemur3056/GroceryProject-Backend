...
public class FLAKPSPublicSoap
{
    ...
    public FLAKPSPublicSoap(){}

    public FLAKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public FLAKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        FLAExtendedSoapSerializationEnvelope envelope= new FLAExtendedSoapSerializationEnvelope(FLAExtendedSoapSerializationEnvelope.VER11);
