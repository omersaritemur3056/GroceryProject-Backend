...
public class FLAExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(FLADateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new FLAStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static FLADateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static FLADateTimeConverter dateTimeConverter = new FLAStandardDateTimeConverter();

    public FLAExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public FLAExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new FLAMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=FLAHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,FLAExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=FLAHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
