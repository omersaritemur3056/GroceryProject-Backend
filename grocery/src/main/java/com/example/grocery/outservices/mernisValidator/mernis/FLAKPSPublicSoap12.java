package com.example.grocery.outservices.mernisValidator.mernis;
...
public class FLAKPSPublicSoap12
{
    interface FLAIWcfMethod
    {
        FLAExtendedSoapSerializationEnvelope CreateSoapEnvelope() throws java.lang.Exception;

        java.lang.Object ProcessResult(FLAExtendedSoapSerializationEnvelope __envelope,java.lang.Object result) throws java.lang.Exception;
    }
    ...
    public FLAKPSPublicSoap12(){}

    public FLAKPSPublicSoap12(String url)
    {
        this.url = url;
    }

    public FLAKPSPublicSoap12(String url,int timeOut)
    {
        this.url = url;
    ...
    protected FLAExtendedSoapSerializationEnvelope createEnvelope()
    {
        FLAExtendedSoapSerializationEnvelope envelope= new FLAExtendedSoapSerializationEnvelope(FLAExtendedSoapSerializationEnvelope.VER12);
        envelope.setEnableLogging( enableLogging);
    
        return envelope;
    }

    protected java.util.List sendRequest(String methodName,FLAExtendedSoapSerializationEnvelope envelope,org.ksoap2.transport.Transport transport ,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile )throws java.lang.Exception
    {
    ...
    java.lang.Object getResult(java.lang.Class destObj,java.lang.Object source,String resultName,FLAExtendedSoapSerializationEnvelope __envelope) throws java.lang.Exception
    {
        if(source==null)
        {
            return null;
    ...
    public Boolean TCKimlikNoDogrula(final Long TCKimlikNo,final String Ad,final String Soyad,final Integer DogumYili) throws java.lang.Exception
    {
        ...
        return (Boolean)execute(new FLAIWcfMethod()
        {
            @Override
            public FLAExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                FLAExtendedSoapSerializationEnvelope __envelope = createEnvelope();
            ...
            @Override
            public java.lang.Object ProcessResult(FLAExtendedSoapSerializationEnvelope __envelope,java.lang.Object __result)throws java.lang.Exception {
    ...
    protected java.lang.Object execute(FLAIWcfMethod wcfMethod,String methodName,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile) throws java.lang.Exception
    {
        org.ksoap2.transport.Transport __httpTransport=createTransport();
        __httpTransport.debug=enableLogging;
        FLAExtendedSoapSerializationEnvelope __envelope=wcfMethod.CreateSoapEnvelope();
        try
        {
    ...
    protected java.lang.Exception convertToException(org.ksoap2.SoapFault fault,FLAExtendedSoapSerializationEnvelope envelope)
    {
